	...
	static void b() {
		...
		BlockDispenser.REGISTRY.a(Items.SPAWN_EGG, new DispenseBehaviorItem() {
			...
			public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
				...
				Entity entity = ItemMonsterEgg.spawnCreature(isourceblock.getWorld(), itemstack.getData(),
		...
		BlockDispenser.REGISTRY.a(Items.FIREWORKS, new DispenseBehaviorItem() {
			...
			public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
				...
				itemstack1 = CraftItemStack.asNMSCopy(event.getItem());
				EntityFireworks entityfireworks = new EntityFireworks(isourceblock.getWorld(),
