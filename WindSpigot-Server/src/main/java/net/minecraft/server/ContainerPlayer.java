...
public class ContainerPlayer extends Container {
	...
	public ContainerPlayer(final PlayerInventory playerinventory, boolean flag, EntityHuman entityhuman) {
		this.g = flag;
		this.h = entityhuman;
		this.resultInventory = new InventoryCraftResult(); // CraftBukkit - moved to before InventoryCrafting
															// construction
		...
		// this.a((IInventory) this.craftInventory); // CraftBukkit - unneeded since it
	...
	public void a(IInventory iinventory) {
		...
		// CraftBukkit start (Note: the following line would cause an error if called
		// during construction)
