...
public abstract class EntityCreature extends EntityInsentient {
	...
	public static final AttributeModifier bl = (new AttributeModifier(EntityCreature.bk, "Fleeing speed bonus", 2.0D,
			2)).a(false);
			...
			if (this instanceof EntityTameableAnimal && ((EntityTameableAnimal) this).isSitting()) {
				if (f > 10.0F) {
					this.world.getServer().getPluginManager().callEvent(
							new EntityUnleashEvent(this.getBukkitEntity(), EntityUnleashEvent.UnleashReason.DISTANCE)); // CraftBukkit
