...
public class ChunkProviderServer implements IChunkProvider {
	...
	public Long2ObjectMap<Chunk> chunks = new Long2ObjectOpenHashMap<>(4096, 0.5f); // TacoSpigot - use trove
																					// Long2ObjectOpenHashMap instead of
																					// craftbukkit implementation (using
																					// inital capacity and load factor
																					// chosen by Amaranth in an old
																					// impl)
	...
	// CraftBukkit start - Change return type to Collection and return the values of
	// our chunk map
	...
	public void queueUnload(int i, int j) {
		...
		// PaperSpigot end
		// PaperSpigot start - Don't unload chunk if it contains an entity that loads
		// chunks
		if (chunk != null) {
	...
	public Chunk originalGetChunkAt(int i, int j) {
		...
		if (chunk == null) {
			...
			if (server != null) {
				/*
				 * If it's a new world, the first few chunks are generated inside the World
				 * constructor. We can't reliably alter that, so we have no way of creating a
