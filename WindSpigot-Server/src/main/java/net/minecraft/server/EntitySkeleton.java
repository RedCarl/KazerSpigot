...
public class EntitySkeleton extends EntityMonster implements IRangedEntity {
	...
	public void die(DamageSource damagesource) {
		...
		if (damagesource.i() instanceof EntityArrow && damagesource.getEntity() instanceof EntityHuman) {
			...
			// CraftBukkit start
			// this.a(new ItemStack(Items.SKULL, 1, this.getSkeletonType() == 1 ? 1 : 0),
			// 0.0F);
	...
	/*
	 * CraftBukkit start protected Item getLoot() { return Items.ARROW; } //
	 * CraftBukkit end
	 */
	...
	public void a(EntityLiving entityliving, float f) {
		...
		org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.event.CraftEventFactory
				.callEntityShootBowEvent(this, this.bA(), entityarrow, 0.8F);
		if (event.isCancelled()) {
