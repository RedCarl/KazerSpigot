...
public class BlockFire extends Block {
	...
	protected BlockFire() {
		...
		this.j(this.blockStateList.getBlockData().set(BlockFire.AGE, 0)
				.set(BlockFire.FLIP, Boolean.FALSE).set(BlockFire.ALT, Boolean.FALSE)
				.set(BlockFire.NORTH, Boolean.FALSE).set(BlockFire.EAST, Boolean.FALSE)
				.set(BlockFire.SOUTH, Boolean.FALSE).set(BlockFire.WEST, Boolean.FALSE)
