...
public abstract class EntityHanging extends Entity {
	 ...
	 * 
	 * l is from function l() m is from function m()
	 * 
	 * Placing here as it's more likely to be noticed as something which needs to be
	 * updated then something in a CraftBukkit file.
	 */
