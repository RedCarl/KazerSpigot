...
public class TileEntityChest extends TileEntityContainer implements IInventory { // PaperSpigot - remove
	...
	public void c() {
		 ...
		 * ++this.n; float f;
		 * 
		 * if (!this.world.isClientSide && this.l != 0 && (this.n + i + j + k) % 200 ==
		 * 0) { this.l = 0; f = 5.0F; List list = this.world.a(EntityHuman.class, new
		 * AxisAlignedBB((double) ((float) i - f), (double) ((float) j - f), (double)
		 * ((float) k - f), (double) ((float) (i + 1) + f), (double) ((float) (j + 1) +
		 * f), (double) ((float) (k + 1) + f))); Iterator iterator = list.iterator();
		 * 
		 * while (iterator.hasNext()) { EntityHuman entityhuman = (EntityHuman)
		 * iterator.next();
		 * 
		 * if (entityhuman.activeContainer instanceof ContainerChest) { IInventory
		 * iinventory = ((ContainerChest) entityhuman.activeContainer).e();
		 * 
		 * if (iinventory == this || iinventory instanceof InventoryLargeChest &&
		 * ((InventoryLargeChest) iinventory).a((IInventory) this)) { ++this.l; } } } }
		 * 
		 * this.k = this.j; f = 0.1F; double d0;
		 * 
		 * if (this.l > 0 && this.j == 0.0F && this.f == null && this.h == null) {
		 * double d1 = (double) i + 0.5D;
		 * 
		 * d0 = (double) k + 0.5D; if (this.i != null) { d0 += 0.5D; }
		 * 
		 * if (this.g != null) { d1 += 0.5D; }
		 * 
		 * this.world.makeSound(d1, (double) j + 0.5D, d0, "random.chestopen", 0.5F,
		 * this.world.random.nextFloat() * 0.1F + 0.9F); }
		 * 
		 * if (this.l == 0 && this.j > 0.0F || this.l > 0 && this.j < 1.0F) { float f1 =
		 * this.j;
		 * 
		 * if (this.l > 0) { this.j += f; } else { this.j -= f; }
		 * 
		 * if (this.j > 1.0F) { this.j = 1.0F; }
		 * 
		 * float f2 = 0.5F;
		 * 
		 * if (this.j < f2 && f1 >= f2 && this.f == null && this.h == null) { d0 =
		 * (double) i + 0.5D; double d2 = (double) k + 0.5D;
		 * 
		 * if (this.i != null) { d2 += 0.5D; }
		 * 
		 * if (this.g != null) { d0 += 0.5D; }
		 * 
		 * this.world.makeSound(d0, (double) j + 0.5D, d2, "random.chestclosed", 0.5F,
		 * this.world.random.nextFloat() * 0.1F + 0.9F); }
		 * 
