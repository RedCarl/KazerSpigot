...
public class EntityCreeper extends EntityMonster {
	...
	public void onLightningStrike(EntityLightning entitylightning) {
		...
		// CraftBukkit start
		if (CraftEventFactory.callCreeperPowerEvent(this, entitylightning,
	...
	protected boolean a(EntityHuman entityhuman) {
		...
		if (itemstack != null && itemstack.getItem() == Items.FLINT_AND_STEEL) {
			this.world.makeSound(this.locX + 0.5D, this.locY + 0.5D, this.locZ + 0.5D, "fire.ignite", 1.0F,
	...
	private void cr() {
		if (!this.world.isClientSide) {
			...
			ExplosionPrimeEvent event = new ExplosionPrimeEvent(this.getBukkitEntity(), this.explosionRadius * f,
					false);
