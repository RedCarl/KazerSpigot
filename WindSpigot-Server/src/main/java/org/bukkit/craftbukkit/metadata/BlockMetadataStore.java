...
public class BlockMetadataStore extends MetadataStoreBase<Block> implements MetadataStore<Block> {
	...
	/**
	 * Retrieves the metadata for a {@link Block}, ensuring the block being asked
	 * for actually belongs to this BlockMetadataStore's owning world.
	 * 
	...
	/**
	 * Tests to see if a metadata value has been added to a {@link Block}, ensuring
	 * the block being interrogated belongs to this BlockMetadataStore's owning
	 * world.
	 * 
	 ...
	 * BlockMetadataStore's owning world.
	 * 
	 * @see MetadataStoreBase#setMetadata(Object, String,
