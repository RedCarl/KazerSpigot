...
class CraftMetaFirework extends CraftMetaItem implements FireworkMeta {
	/*
	 * "Fireworks", "Explosion", "Explosions", "Flight", "Type", "Trail", "Flicker",
	 * "Colors", "FadeColors";
	 * 
	 * Fireworks - Compound: Fireworks -- Byte: Flight -- List: Explosions ---
	 * Compound: Explosion ---- IntArray: Colors ---- Byte: Type ---- Boolean: Trail
	 * ---- Boolean: Flicker ---- IntArray: FadeColors
	 */
