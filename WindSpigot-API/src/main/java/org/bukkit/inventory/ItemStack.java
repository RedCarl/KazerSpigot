...
public class ItemStack implements Cloneable, ConfigurationSerializable {
	 ...
	 * @throws IllegalArgumentException if the specified stack is null or returns an
	 *                                  item meta not created by the item factory
	 */
	 ...
	 * {@link #addEnchantment(org.bukkit.enchantments.Enchantment, int)} for each
	 * element of the map.
	 *
	 * @param enchantments Enchantments to add
	 * @throws IllegalArgumentException if the specified enchantments is null
	 * @throws IllegalArgumentException if any specific enchantment or level is
	 *                                  null. <b>Warning</b>: Some enchantments may
	 *                                  be added before this exception is thrown.
	 */
	@Utility
	 ...
	 * <p>
	 * If this item stack already contained the given enchantment (at any level), it
	 * will be replaced.
	 *
	 * @param ench  Enchantment to add
	 * @param level Level of the enchantment
	 * @throws IllegalArgumentException if enchantment null, or enchantment is not
	 *                                  applicable
	 */
	@Utility
	 ...
	 * <p>
	 * This method is the same as calling
	 * {@link #addUnsafeEnchantment(org.bukkit.enchantments.Enchantment, int)} for
	 ...
	 * will be replaced.
	 * <p>
	 * This method is unsafe and will ignore level restrictions or item type. Use at
	 * your own discretion.
	 *
	 * @param ench  Enchantment to add
	 * @param level Level of the enchantment
	 ...
	 *         {@link ItemFactory#isApplicable(ItemMeta, ItemStack)}
	 * @throws IllegalArgumentException if the item meta was not created by the
	 *                                  {@link ItemFactory}
	 */
