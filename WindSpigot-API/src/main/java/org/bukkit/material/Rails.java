...
public class Rails extends MaterialData {
	 ...
	 *         the ascending direction if the track is set on a slope. If it is set
	 *         as a curve, the corner of the track is returned.
	 */
	...
	/**
	 * Return the data without the extended properties used by {@link PoweredRail}
	 * and {@link DetectorRail}. Overridden in {@link ExtendedRails}
	 *
	 ...
	 * <p>
	 * Note that tracks are bidirectional and that the direction returned is the
	 * ascending direction if the track is set on a slope. If it is set as a curve,
	 * the corner of the track should be supplied.
	 *
