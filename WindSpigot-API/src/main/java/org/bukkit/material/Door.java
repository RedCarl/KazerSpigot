...
public class Door extends MaterialData implements Directional, Openable {
	 ...
	 *             <code>Door(Material.WOODEN_DOOR);</code>
	 */
	@Deprecated
	public Door() {
	...
	/**
	 * Constructs the bottom half of a door of the given material type, facing the
	 * specified direction and set to closed
	 *
	 * @param type The type of material this door is made of. This must match the
	 *             type of the block above.
	...
	/**
	 * Constructs the bottom half of a door of the given material type, facing the
	 * specified direction and set to open or closed
	 *
	 * @param type   The type of material this door is made of. This must match the
	 *               type of the block above.
	 * @param face   The direction the door is facing.
	...
	/**
	 * Constructs the top half of door of the given material type and with the hinge
	 * on the left or right
	 *
	 * @param type         The type of material this door is made of. This must
	 *                     match the type of the block below.
	 * @param isHingeRight True if the hinge is on the right hand side, false if the
	 *                     hinge is on the left hand side.
	 *
	 * @see Material.WOODEN_DOOR
	 * @see Material.IRON_DOOR_BLOCK
	 * @see Material.SPRUCE_DOOR
	...
	/**
	 * Constructs the bottom half of a wooden door of the given species, facing the
	 * specified direction and set to closed
	 *
	 * @param species The species this wooden door is made of. This must match the
	 *                species of the block above.
	 * @param face    The direction the door is facing.
	 *
	 * @see TreeSpecies
	 *
	...
	/**
	 * Constructs the top half of a wooden door of the given species and with the
	 * hinge on the left or right
	 *
	 * @param species      The species this wooden door is made of. This must match
	 *                     the species of the block below.
	 * @param isHingeRight True if the hinge is on the right hand side, false if the
	 *                     hinge is on the left hand side.
	 *
	 * @see TreeSpecies
	 ...
	 * @deprecated This method should not be used; use hinge and facing accessors
	 *             instead.
	 */
	@Deprecated
