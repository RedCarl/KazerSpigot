...
public class Mushroom extends MaterialData {
	...
	public Mushroom(int type, byte data) {
		super(type, data);
		Validate.isTrue(type == Material.HUGE_MUSHROOM_1.getId() || type == Material.HUGE_MUSHROOM_2.getId(),
				"Not a mushroom!");
	}
	...
	/**
	 * Set a face of the block to be painted or not. Note that due to the nature of
	 * how the data is stored, setting a face painted or not is not guaranteed to
	 * leave the other faces unchanged.
	 *
	 * @param face    The face to paint or unpaint.
	 * @param painted True if you want to paint it, false if you want the pores to
	 *                show.
	 */
	...
	/**
	 * @return A set of all faces that are currently painted (an empty set if it is
	 *         a stem)
	 */
