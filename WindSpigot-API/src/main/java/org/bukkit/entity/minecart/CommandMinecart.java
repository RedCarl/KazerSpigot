...
public interface CommandMinecart extends Minecart, CommandSender {
	...
	/**
	 * Gets the command that this CommandMinecart will run when activated. This will
	 * never return null. If the CommandMinecart does not have a command, an empty
	 ...
	 * the command to null is the same as setting it to an empty String.
	 *
	 ...
	 * this CommandMinecart executes. Setting the name to null is the same as
	 * setting it to "@".
	 *
