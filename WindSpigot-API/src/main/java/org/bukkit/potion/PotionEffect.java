...
public class PotionEffect implements ConfigurationSerializable {
	 ...
	 * effect happens more often over its duration and in some cases has more effect
	 * on its target.
	 *
	...
	/**
	 * Returns the duration (in ticks) that this effect will run for when applied to
	 * a {@link LivingEntity}.
	 *
