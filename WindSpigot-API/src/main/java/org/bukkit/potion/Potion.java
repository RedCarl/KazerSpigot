...
public class Potion {
	 ...
	 * {@link PotionType#WATER}, it will be level one, without extended duration.
	 * Don't use this constructor to create a no-effect potion other than water
	 * bottle.
	 *
	 ...
	 * @deprecated In favour of using {@link #Potion(PotionType)} with
	 *             {@link #splash()}.
	 */
	@Deprecated
	 ...
	 * @deprecated In favour of using {@link #Potion(PotionType)} with
	 *             {@link #extend()} and possibly {@link #splash()}.
	 */
	@Deprecated
	...
	public Potion(int name) {
		...
		if ((name & POTION_BIT) == 0) {
			// If it's 0 it would've become PotionType.WATER, but it should actually be
			// mundane potion
			this.type = null;
		}
	}
	...
	/**
	 * Returns a collection of {@link PotionEffect}s that this {@link Potion} would
	 * confer upon a {@link LivingEntity}.
	 *
	...
	/**
	 * Set whether this potion has extended duration. This will cause the potion to
	 * have roughly 8/3 more duration than a regular potion.
	 *
	...
	/**
	 * Sets whether this potion is a splash potion. Splash potions can be thrown for
	 * a radius effect.
	 *
	...
	/**
	 * Converts this potion to a valid potion damage short, usable for potion item
	 * stacks.
	 *
	...
	/**
	 * Converts this potion to an {@link ItemStack} with the specified amount and a
	 * correct damage value.
	 *
	...
	/**
	 * Sets the current instance of {@link PotionBrewer}. Generally not to be used
