...
/**
 * An InactivityConversationCanceller will cancel a {@link Conversation} after a
...
public class InactivityConversationCanceller implements ConversationCanceller {
	...
	/**
	 * Subclasses of InactivityConversationCanceller can override this method to
	 * take additional actions when the inactivity timer abandons the conversation.
	 *
