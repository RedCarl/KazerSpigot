...
public class Note {
	...
	public enum Tone {
		...
		/**
		 * Returns the id of this tone. These method allows to return the sharped id of
		 * the tone. If the tone couldn't be sharped it always return the not sharped id
		 * of this tone.
		 *
		 ...
		 * @throws IllegalArgumentException if neither the tone nor the semitone have
		 *                                  the id.
		 * @deprecated Magic value
		 */
		@Deprecated
	 ...
	 * Creates a new note.
	 *
	 * @param note Internal note id. {@link #getId()} always return this value. The
	 *             value has to be in the interval [0;&nbsp;24].
	 */
	 ...
	 * @param tone    The tone within the octave. If the octave is 2 the note has to
	 *                be F#.
