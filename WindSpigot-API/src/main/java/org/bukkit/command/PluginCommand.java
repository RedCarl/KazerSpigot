...
public final class PluginCommand extends Command implements PluginIdentifiableCommand {
	...
	public java.util.List<String> tabComplete(CommandSender sender, String alias, String[] args)
		...
		return tabComplete(sender, alias, args, null); // PaperSpigot - The code from this method has been (slightly
														// modified) moved to the Location method.
	}

	// PaperSpigot start - location tab-completes
	/**
	 * This code was copied from tabComplete(CommandSender sender, String alias,
	 * String[] args)
	 */
	@Override
	public List<String> tabComplete(CommandSender sender, String alias, String[] args, Location location)
		...
		try {
			if (completer != null) {
				completions = completer.onTabComplete(sender, this, alias, args, location); // PaperSpigot - add
																							// location argument
			}
			if (completions == null && executor instanceof TabCompleter) {
				completions = ((TabCompleter) executor).onTabComplete(sender, this, alias, args, location); // PaperSpigot
																											// - add
																											// location
																											// argument
			}
