 ...
 * <p>
 * These fields are hee base color ranges. Each entry corresponds to four colors
 * of varying shades with values entry to entry + 3.
 */
public final class MapPalette {
	...
	static final Color[] colors = { c(0, 0, 0), c(0, 0, 0), c(0, 0, 0), c(0, 0, 0), c(89, 125, 39), c(109, 153, 48),
