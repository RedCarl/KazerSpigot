...
public final class Color implements ConfigurationSerializable {
	 ...
	 * @throws IllegalArgumentException if any value is strictly
	 *                                  {@literal >255 or <0}
	 */
	...
	/**
	 * Creates a new color object from an integer that contains the red, green, and
	 * blue bytes in the lowest order 24 bits.
	 *
	...
	/**
	 * Creates a new color object from an integer that contains the blue, green, and
	 * red bytes in the lowest order 24 bits.
	 *
	...
	/**
	 * Creates a new color with its RGB components changed as if it was dyed with
	 * the colors passed in, replicating vanilla workbench dyeing
	 *
