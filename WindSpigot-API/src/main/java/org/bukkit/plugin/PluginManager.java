...
public interface PluginManager {
	 ...
	 *                                     valid plugin
	 * @throws InvalidDescriptionException Thrown when the specified file contains
	 *                                     an invalid description
	 * @throws UnknownDependencyException  If a required dependency could not be
	 *                                     resolved
	 */
	 ...
	 * <p>
	 * If the specified permission does not exist in this plugin manager, nothing
	 * will happen.
	 * <p>
	 * Removing a permission registration will <b>not</b> remove the permission from
	 * any {@link Permissible}s that have it.
	 *
	 ...
	 * Permission, by name.
	 * <p>
	 * If the specified Permission changes in any form, the Permissible will be
	 ...
	 * <p>
	 * If the specified defaults change in any form, the Permissible will be asked
	 * to recalculate.
	 *
