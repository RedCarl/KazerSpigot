...
/**
 * Represents a plugin loader, which handles direct access to specific types of
 * plugins
 */
public interface PluginLoader {
	 ...
	 *         specified file
	 * @throws InvalidDescriptionException If the plugin description file could not
	 *                                     be created
	 */
	...
	/**
	 * Creates and returns registered listeners for the event classes used in this
	 * listener
	 *
