...
public abstract class JavaPlugin extends PluginBase {
	...
	/**
	 * @deprecated This method is intended for unit testing purposes when the other
	 *             {@linkplain #JavaPlugin(JavaPluginLoader, PluginDescriptionFile, File, File)
	...
	/**
	 * Returns the folder that the plugin data's files are located in. The folder
	 * may not yet exist.
	 *
	 * @return The folder.
	 */
	...
	/**
	 * Provides a reader for a text file located inside the jar. The behavior of
	 * this method adheres to {@link PluginAwareness.Flags#UTF8}, or if not defined,
	 * uses UTF8 if {@link FileConfiguration#UTF8_OVERRIDE} is specified, or system
	 * default otherwise.
	 *
	 ...
	 * @deprecated This method is legacy and will be removed - it must be replaced
	 *             by the specially provided constructor(s).
	 */
	@Deprecated
	 ...
	 * @deprecated This method cannot return false, as {@link JavaPlugin} is now
	...
	/**
	 * Gets the command with the given name, specific to this plugin. Commands need
	 * to be registered in the {@link PluginDescriptionFile#getCommands()
	 ...
	 * {@link #getProvidingPlugin(Class) provided} the given plugin class, which is
	 * usually the plugin that implemented it.
	 * <p>
	 * An exception to this would be if plugin's jar that contained the class does
	 * not extend the class, where the intended plugin would have resided in a
	 * different jar / classloader.
	 *
	...
	/**
	 * This method provides fast access to the plugin that has provided the given
	 * class.
	 *
