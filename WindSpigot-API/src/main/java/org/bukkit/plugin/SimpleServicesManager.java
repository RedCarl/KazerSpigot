...
public class SimpleServicesManager implements ServicesManager {
	...
	/**
	 * Queries for a provider. This may return if no provider has been registered
	 * for a service. The highest priority provider is returned.
	 *
	...
	/**
	 * Queries for a provider registration. This may return if no provider has been
	...
	/**
	 * Get registrations of providers for a service. The returned list is an
	 * unmodifiable copy.
	 *
	 * @param <T>     The service interface
	 * @param service The service interface
