...
public interface BlockState extends Metadatable {
	...
	/**
	 * Attempts to update the block represented by this state, setting it to the new
	 * values as defined by this state.
	 * <p>
	 * This has the same effect as calling update(false). That is to say, this will
	 * not modify the state of a block if it is no longer the same type as it was
	 * when this state was taken. It will return false in this eventuality.
	 *
	 ...
	 * values as defined by this state.
	 * <p>
	 * This has the same effect as calling update(force, true). That is to say, this
	 * will trigger a physics update to surrounding blocks.
	 *
	 ...
	 * values as defined by this state.
	 * <p>
	 * Unless force is true, this will not modify the state of a block if it is no
	 * longer the same type as it was when this state was taken. It will return
	 ...
	 *
	 * @return whether the state is placed in the world or 'virtual' (e.g. on an
	 *         itemstack)
	 */
	boolean isPlaced();
}
