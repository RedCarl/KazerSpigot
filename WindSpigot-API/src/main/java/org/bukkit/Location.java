...
public class Location implements Cloneable, ConfigurationSerializable {
	 ...
	 *
	 * @return a vector pointing the direction of this location's {@link #getPitch()
	...
	/**
	 * Sets the {@link #getYaw() yaw} and {@link #getPitch() pitch} to point in the
	 ...
	 * not repeatedly call this method to get the location's magnitude. NaN will be
	...
	/**
	 * Gets the magnitude of the location squared. Not world-aware and orientation
	 * independent.
	 *
	 * @see Vector
	 * @return the magnitude
	...
	/**
	 * Get the distance between this location and another. The value of this method
	 * is not cached and uses a costly square-root function, so do not repeatedly
	 * call this method to get the location's magnitude. NaN will be returned if the
