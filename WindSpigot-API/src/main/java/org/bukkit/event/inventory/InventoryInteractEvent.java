...
public abstract class InventoryInteractEvent extends InventoryEvent implements Cancellable {
	...
	/**
	 * Sets the result of this event. This will change whether or not this event is
	...
	/**
	 * Gets the {@link Result} of this event. The Result describes the behavior that
	 * will be applied to the inventory in relation to this event.
	 *
	...
	/**
	 * Gets whether or not this event is cancelled. This is based off of the Result
	 * value returned by {@link #getResult()}. Result.ALLOW and Result.DEFAULT will
	 * result in a returned value of false, but Result.DENY will result in a
	 * returned value of true.
	 * <p>
	 * {@inheritDoc}
	 *
